...
- 19 个分类、140 道题，覆盖 Go 核心、MySQL、Redis、Kafka、Kubernetes、微服务治理等主题
...
- 当前已并入七批高优题，覆盖 Shoply 项目深挖、gRPC、性能优化、手撕题、可观测性、CI/CD、DDD、K8s Operator、AWS、搜广推基础、AIGC 推理、测试工程、弱网优化、程序化广告、LangChain 基础，以及 RESTful 设计、缓存一致性、队列治理、SSE 流式输出、MongoDB 事务和多批真实面经高频题
